...
<head>
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .about-content {
        display: grid;
        grid-template-columns: 1fr 1.5fr; /* Image takes 40%, Text takes 60% */
        gap: 4rem;
        align-items: start;
    }
    .about-image { width: 90%; aspect-ratio: 3/4; object-fit: cover; border-radius: 4px; }
...
@media (max-width: 768px) {
    ...
    .gallery-grid { 
     ...
     /* Force 2 columns by default */
    .gallery-grid { grid-template-columns: repeat(2, 1fr); }
    
    /* ALLOW 3 columns if user clicks the button */
    .gallery-grid.grid-3 { grid-template-columns: repeat(3, 1fr) !important; }
    
    /* Force 4 columns back to 2 (too small for phone) */
    .gallery-grid.grid-4 { grid-template-columns: repeat(2, 1fr) !important; }
    
    /* Hide the "4 Col" button on mobile only */
    .grid-toggle[onclick*="4"] { display: none; }

    /* General Mobile Layout Adjustments */
    /* THIS WAS THE FIX: These are now inside the media query */
    .about-content { grid-template-columns: 1fr; gap: 2rem; }
    .about-details { grid-template-columns: 1fr; }
    section { padding: 3rem 1rem; }
    .share-btn { bottom: 1rem; right: 1rem; }
    .social-embed { padding: 1rem; }
} /* <--- This is the correct closing bracket location */

@media (max-width: 480px) {
    /* Optional: On very tiny screens, you might still want to force 2 columns 
       even if they clicked 3, or you can remove the line below to allow 3 on tiny screens */
...
<body>
    ...
    <nav>
        ...
        <div class='nav-links' id='navLinks'>
            <!-- These links now include the Homepage URL + the section ID -->
            <a expr:href='data:blog.homepageUrl + &quot;#work&quot;'>Work</a>
            <a expr:href='data:blog.homepageUrl + &quot;#media&quot;'>Media</a>
            <a expr:href='data:blog.homepageUrl + &quot;#about&quot;'>About</a>
            <a expr:href='data:blog.homepageUrl + &quot;#exhibitions&quot;'>Exhibitions</a>
            <a expr:href='data:blog.homepageUrl + &quot;#news&quot;'>News</a>
            <a expr:href='data:blog.homepageUrl + &quot;#contact&quot;'>Contact</a>
                  ...
                  <b:widget-setting name='content'><![CDATA[<!-- PASTE YOUR SLIDESHOW HTML HERE IN THE WIDGET EDITOR -->
                        <div class="hero" id="home">
                            <div class="hero-slideshow">
                                <div class="hero-slide active"><img src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhCwF_MD5X1gwfhHPEjGq5dRyEjyUfsAzuroEB7TvKIyxN8IlY8VizEAJs99NEn7J_KTde6FHbevZbW06j_Msemu-OOjKglnC7hlAO-hPPkBz6ySaCkz4-W_LpFcqKpMEULlfOlBxIdqY-QAFDt2ubGVQOhY3XroypcRWpU7nTb5bgyfZgedtE6SVc4MMg/s16000/Rozp%C3%ADnavost%20temnoty%20III,%202021,%20olej%20na%20pl%C3%A1tn%C4%9B,%20170%20x%20120%20cm.jpg" alt="Art 1" /></div>
                                <div class="hero-slide"><img src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhRqV2LASrZWhWw5uLG53sWthrQKLj7-3ujx9zLwdqJihpRo8W1zSCO0EFKXACbwQwfolacyzZKTCPwddoXdbcgDnpM6pVZwp0JwB9lgEyqCkEy_EHPoq1_WPSxPwJVq0TQQyusFG2QjQJ-MBtrIfsOUoFx8u0eMHWR5DIo1XYCrpQqvX4rGN3oS1HORms/s16000/Detail%20III.jpg" alt="Art 2" /></div>
                                <div class="hero-slide"><img src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEho9ae4VQ1VZtWRDokj-v5tCj8L5ZgDIKSemTxnag5b7HoZEbWw5ML8NFQkvWKsm66566r2D3qVy_N3NiH-sPw0GsXdcT73a2XTdSHFRR4r5R3EEvKs5iyaxOJPt3pDvUraK9T-jzSm7a5xJehoBuUNqySa82ylTW7H6r18goLMVM9VCQmTDEXOjeZ6U4U/s16000/Detail%20II.jpg" alt="Art 3" /></div>
                            </div>
...
<section id="news">
    ...
    <div class="contact-content">
        ...
        <a href="mailto:info@marketapragerova.com" class="contact-email">info@marketapragerova.com</a>
        <div class="social-links">
            <a href="https://www.instagram.com/marketaprager" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
            ...
            <a href="https://www.facebook.com/share/17DgsKAjLf/" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
                <svg viewbox="0 0 24 24">
            ...
            document.querySelectorAll('.nav-links a').forEach(anchor => {
                anchor.addEventListener('click', function (e) {
                    ...
                    if (href && href.includes('#')) {
                        // Extract the ID (e.g., "work")
                        const targetId = href.split('#')[1];
                        const targetElement = document.getElementById(targetId);

                        // IF the section exists on the CURRENT page (we are on Homepage)
                        if (targetElement) {
                            e.preventDefault(); // Stop the reload
                            targetElement.scrollIntoView({ behavior: 'smooth' });
                            document.getElementById('navLinks').classList.remove('active'); // Close mobile menu
                            
                            // Optional: Update the URL bar without reloading
                            history.pushState(null, null, '#' + targetId);
                        }
                        // IF the section does NOT exist (we are on a Post Page)
                        // We do nothing, and the browser naturally loads the Homepage URL
                    }
                });
            });
